...
impl CheckpointMessage {
    ...
    pub const FIELD_SIZES: [usize; 4] = [32, 32, 8, 4];
...
impl molecule::prelude::Entity for VerificationWitness {
    ...
    fn as_builder(self) -> Self::Builder {
        Self::new_builder().checkpoint_messages(self.checkpoint_messages())
    }
}
#[derive(Clone, Copy)]
...
impl<'r> molecule::prelude::Reader<'r> for VerificationWitnessReader<'r> {
    ...
    fn verify(slice: &[u8], compatible: bool) -> molecule::error::VerificationResult<()> {
        ...
        CheckpointMessageVecReader::verify(&slice[offsets[0]..offsets[1]], compatible)?;
        Ok(())
    }
}
#[derive(Clone, Debug, Default)]
...
impl molecule::prelude::Builder for VerificationWitnessBuilder {
    ...
    fn expected_length(&self) -> usize {
        molecule::NUMBER_SIZE * (Self::FIELD_COUNT + 1) + self.checkpoint_messages.as_slice().len()
    }
    fn write<W: molecule::io::Write>(&self, writer: &mut W) -> molecule::io::Result<()> {
